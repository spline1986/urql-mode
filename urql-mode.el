(setq urql-highlights
      '(("#%.+\\$\\|#.+\\$\\|0x[0-9a-z]\\{6,8\\}\\|[0-9]+" . font-lock-constant-face)
		...
		("proc\\|pln\\|println\\|print\\|fpln\\|fprint\\|fprintln\\|fp\\|newfile\\|btn\\|goto\\|inv[\\+|-]\\|if\\|else\\|then\\|\\(inv\\|per\\)kill\\|play\\|loop\\|stop\\|voice\\|fademusic\\|music\\|instr\\|input\\|include\\|pause\\|anykey\\|tokens\\|save\\|clsb?\\|and\\|not\\|or\\|forget_procs\\|rnd\\|decor\\(add\\|mov\\|col\\|rot\\|del\\|scl\\|scr\\)\\|&\\|_\\|p" . font-lock-keyword-face)
